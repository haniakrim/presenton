...
type GenerationModeDialogProps = {
  ...
  onSelect: (mode: UploadModeSelection) => void;
};
...
export default function GenerationModeDialog({
  ...
  const selectMode = (mode: UploadModeSelection) => {
    onSelect(mode);
    onOpenChange(false);
  };
        ...
        >
          ...
          >
            <DialogPrimitive.Description className="sr-only">
              Choose Standard mode for fixed layouts, Smart mode for adaptive
              layouts, or Skywork for a hosted-AI generated deck.
          ...
          <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
            ...
            <div>
              ...
              <div className="rounded-[20px] border border-[#EBE9FE] bg-[#F4F3FF] px-3.5 pb-5 pt-3.5">
                ...
                <p className="mb-2 py-1.5 text-base font-medium text-[#666666]">
                  Generated by Skywork's hosted AI and delivered as a
                  downloadable file, outside the built-in editor.
                </p>
                <Button
                  type="button"
